...
const ThumbsUp = () => {
  const [toggleButton, setToggleButton] = useRecoilState(toggleButtonState);
    ...
    <>
      <IconButton
        ...
        className={`!bg-darkGray !rounded-md !p-3 !w-16 !h-16 text-blue hover:text-cyan duration-300 ${
          toggleButton === 'like' ? '!text-white !bg-blue' : ''
        }`}
      >
        <ThubsUpIcon />
      </IconButton>
  ...
  return (
    <>
      <IconButton
        ...
        ariaLabel={'Dislike'}
        className={`!bg-darkGray !rounded-md !p-3 !w-16 !h-16 text-blue hover:text-cyan duration-300 ${
          toggleButton === 'dislike' ? '!text-white !bg-blue' : ''
        }`}
      >
        <ThubsDownIcon />
      </IconButton>
